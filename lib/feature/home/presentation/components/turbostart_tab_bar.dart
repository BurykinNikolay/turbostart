...
const double _kTabBarHeight = 85.0;
...
///
/// When used as [CupertinoTabScaffold.tabBar], by default `TurbostartTabBar` has
...
/// See also:
///
///  * [CupertinoTabScaffold], which hosts the [TurbostartTabBar] at the bottom.
///  * [BottomNavigationBarItem], an item in a [TurbostartTabBar].
class TurbostartTabBar extends StatelessWidget implements PreferredSizeWidget {
  /// Creates a tab bar in the iOS style.
  const TurbostartTabBar({
    Key key,
    @required this.items,
    this.onTap,
    this.currentIndex = 0,
  ...
  /// The border of the [TurbostartTabBar].
  ///
  ...
  List<Widget> _buildTabItems(BuildContext context) {
    ...
    assert(
        localizations != null,
        'TurbostartTabBar requires a Localizations parent in order to provide an '
  ...
  /// Create a clone of the current [TurbostartTabBar] but with provided
  /// parameters overridden.
  TurbostartTabBar copyWith({
    Key key,
