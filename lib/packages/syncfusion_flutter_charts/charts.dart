...
import 'package:turbostart/packages/syncfusion_flutter_core/core.dart';
import 'package:turbostart/packages/syncfusion_flutter_core/theme.dart';

import './src/common/handcursor/mobile.dart' if (dart.library.html) './src/common/handcursor/web.dart';
