      ...
      if (series.dataSource != null) {
        for (int pointIndex = 0;
          ...
          if (xVal != null) {
            ...
            currentPoint = CartesianChartPoint<dynamic>(xVal, yVal);
            if (((!chart._chartState.zoomProgress) &&
              ...
              series._dataPoints.add(currentPoint);
            ...
            if (series._xAxis != null &&
              ...
              _findMinMaxValue(series._xAxis, series, currentPoint, pointIndex,
                  series.dataSource.length, _isXVisibleRange, _isYVisibleRange);
            }
          }
        }
        if (needSorting) {
    ...
    if (series._visible) {
      for (int pointIndex = 0;
        ...
        _findMinMaxValue(axis, series, series._dataPoints[pointIndex],
            pointIndex, series._dataPoints.length, true, true);
      }
    }
  }
