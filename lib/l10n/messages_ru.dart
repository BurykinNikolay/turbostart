...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "iam" : MessageLookupByLibrary.simpleMessage("Я"),
    "login" : MessageLookupByLibrary.simpleMessage("ВОЙТИ"),
    "macroregion" : MessageLookupByLibrary.simpleMessage("Макрорегион"),
    "makeYourContribution" : MessageLookupByLibrary.simpleMessage("Внесите свой вклад\nв большое дело!"),
    "month" : MessageLookupByLibrary.simpleMessage("Месяц"),
    "moveAndAccumulateSteps" : MessageLookupByLibrary.simpleMessage("Двигайтесь\nи накапливайте шаги"),
    "myMacroregion" : MessageLookupByLibrary.simpleMessage("Мой макрорегион"),
    "mySteps" : MessageLookupByLibrary.simpleMessage("Мои шаги"),
    ...
    "steps" : MessageLookupByLibrary.simpleMessage("шагов"),
    "stepsOfMacroregion" : MessageLookupByLibrary.simpleMessage("Шаги макрорегиона"),
    "teamVictoryYourVictory" : MessageLookupByLibrary.simpleMessage("Победа команды —\nваша победа!"),
    "tenThousand" : MessageLookupByLibrary.simpleMessage("Все шаги конвертируются в рубли и идут в\nблаготворительный фонд поддержки\nдетей-спортсменов с ограниченными\nвозможностями."),
